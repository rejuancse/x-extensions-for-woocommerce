...
class Submit_Form {
    ...
    function frontend_data_save(){
        ...
        if ( empty($_POST['xwoo-form-description']) && $show_description == 'true'){
            die(json_encode(array('success'=> 0, 'message' => __('Description required', 'xwoo'))));
        }
        if ( empty($_POST['xwoo-form-short-description']) && $show_short_description == 'true' ){
            die(json_encode(array('success'=> 0, 'message' => __('Short Description required', 'xwoo'))));
        }
        if ( empty($_POST['xwoo-form-funding-goal']) && $show_funding_goal == 'true' ){
            die(json_encode(array('success'=> 0, 'message' => __('Funding goal required', 'xwoo'))));
        }
        if ( empty($_POST['wp_terms_agree']) && $show_terms_and_conditions == 'true' ){
            die(json_encode(array('success'=> 0, 'message' => __('Please check terms condition', 'xwoo'))));
        }

        $title = isset($_POST['xwoo-form-title']) ? sanitize_text_field($_POST['xwoo-form-title']) : '';
        $description = (isset($_POST['xwoo-form-description']) && $show_description == 'true' ) ? $_POST['xwoo-form-description'] : '';
        $short_description = (isset($_POST['xwoo-form-short-description']) && $show_short_description == 'true') ? $_POST['xwoo-form-short-description'] : '';
        $category = (isset($_POST['xwoo-form-category']) && $show_category == 'true') ? sanitize_text_field($_POST['xwoo-form-category']) : '';
        $tag = (isset($_POST['xwoo-form-image-id']) && $show_tag == 'true') ? sanitize_text_field($_POST['xwoo-form-tag']) : '';
        $image_id = (isset($_POST['xwoo-form-image-id']) && $show_feature == 'true') ? sanitize_text_field($_POST['xwoo-form-image-id']) : '';
        $video = (isset($_POST['xwoo-form-video']) && $show_video == 'true') ? sanitize_text_field($_POST['xwoo-form-video']) : '';
        $start_date = (isset($_POST['xwoo-form-start-date']) && $show_start_date == 'true') ? sanitize_text_field($_POST['xwoo-form-start-date']) : '';
        $end_date = (isset($_POST['xwoo-form-end-date']) && $show_end_date == 'true') ? sanitize_text_field($_POST['xwoo-form-end-date']) : '';
        $min_price = (isset($_POST['xwoo-form-min-price']) && $show_min_price == 'true') ? sanitize_text_field($_POST['xwoo-form-min-price']) : '';
        $max_price = (isset($_POST['xwoo-form-max-price']) && $show_max_price == 'true') ? sanitize_text_field($_POST['xwoo-form-max-price']) : ''; 
        $recommended_price = (isset($_POST['xwoo-form-recommended-price']) && $show_recommended_price == 'true') ? sanitize_text_field($_POST['xwoo-form-recommended-price']) : '';
        ...
        $funding_goal = (isset($_POST['xwoo-form-funding-goal']) && $show_funding_goal == 'true') ? sanitize_text_field($_POST['xwoo-form-funding-goal']) : '';
        $type = (isset($_POST['xwoo-form-type']) && $show_end_method == 'true') ? sanitize_text_field($_POST['xwoo-form-type']) : ''; 
        $contributor_table = (isset($_POST['xwoo-form-contributor-table']) && $show_contributor_table == 'true') ? sanitize_text_field($_POST['xwoo-form-contributor-table']) : '';
        $contributor_show = (isset($_POST['xwoo-form-contributor-show']) && $show_contributor_anonymity == 'true') ? sanitize_text_field($_POST['xwoo-form-contributor-show']) : '';
        $paypal = isset($_POST['xwoo-form-paypal']) ? sanitize_text_field($_POST['xwoo-form-paypal']) : ''; 
        $country = (isset($_POST['xwoo-form-country']) && $show_country == 'true') ? sanitize_text_field($_POST['xwoo-form-country']) : '';
        $location = (isset($_POST['xwoo-form-location']) && $show_location == 'true') ? sanitize_text_field($_POST['xwoo-form-location']) : '';
        ...
        if(isset($_POST['edit_form'])){
            ...
            $campaign_status = get_option('wp_campaign_edit_status', 'pending');
            ...
            $my_post['post_status'] = get_option( 'wp_default_campaign_status' );
        ...
        if ($post_id) {
            ...
            if (!empty($_POST['wp_rewards_pladge_amount'])) {
                ...
                $endmonth         = $_POST['wp_rewards_endmonth'];
                $endyear          = $_POST['wp_rewards_endyear'];
                ...
                for ($i = 0; $i < $field_number; $i++) {
                    if (!empty($pladge_amount[$i])) {
                        $data[] = array(
                            ...
                            'wp_rewards_description'     => (($show_reward == 'true' && isset($description[$i])) ? $description[$i] : ''),
                            'wp_rewards_endmonth'        => (($show_estimated_delivery_month == 'true' && isset($endmonth[$i])) ? esc_html($endmonth[$i]) : ''),
                            'wp_rewards_endyear'         => (($show_estimated_delivery_year == 'true' && isset($endyear[$i])) ? esc_html($endyear[$i]) : ''),
                            'wp_rewards_item_limit'      => (($show_quantity == 'true' && isset($item_limit[$i])) ? esc_html($item_limit[$i]) : ''),
                            'wp_rewards_image_field'     => (($show_reward_image == 'true' && isset($image_field[$i])) ? esc_html($image_field[$i]) : ''),
                        );
                    }
                }
