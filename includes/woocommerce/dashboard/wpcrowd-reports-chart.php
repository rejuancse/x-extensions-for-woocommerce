...
if ( ! empty($_GET['date_range'])){
    ...
    switch ($date_range){
        case 'last_7_days':
            $chart_bottom_title = __('1W','xwoo');
            $query_range        = 'day_wise';
            break;
        case 'last_14_days':
            $to_date            = date('Y-m-d 23:59:59');
            $from_date          = date('Y-m-01 00:00:00');
            $chart_bottom_title = __('2W','xwoo');
            $query_range        = 'day_wise';
            break;
    ...
    <div class="wpneo-dashboard-head wpneo-clearfix">
        <div class="wpneo-dashboard-head-left">
            ...
            <ul>
                ...
                <li class="<?php echo ($date_range === 'this_month') ? 'active':''; ?>"><a href="<?php echo add_query_arg(array('date_range' => 'this_month'), get_permalink()); ?>"><?php echo __('1M','xwoo'); ?></a></li>
                <li class="<?php echo ($date_range === 'last_3_months') ? 'active':''; ?>"><a href="<?php echo add_query_arg(array('date_range' => 'last_3_months'), get_permalink()); ?>"><?php echo __('3M','xwoo'); ?></a></li>
                <li class="<?php echo ($date_range === 'last_6_months') ? 'active':''; ?>"><a href="<?php echo add_query_arg(array('date_range' => 'last_6_months'), get_permalink()); ?>"><?php echo __('6M','xwoo'); ?></a></li>
                <li class="<?php echo ($date_range === 'this_year') ? 'active':''; ?>"><a href="<?php echo add_query_arg(array('date_range' => 'this_year'), get_permalink()); ?>"><?php echo __('1Y','xwoo'); ?></a></li>
            </ul>
