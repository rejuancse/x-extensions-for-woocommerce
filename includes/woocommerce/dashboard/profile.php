...
$html .= '<div class="wpneo-content">';
    $html .= '<form id="wpneo-dashboard-form" action="" method="" class="wpneo-form">';
            ...
            $html .= '<div class="wpneo-col6">';
                $html .= '<div class="wpneo-shadow wpneo-padding25 wpneo-clearfix">';
                    ...
                    $html .= '<input type="hidden" name="action" value="wpneo_profile_form">';
                        ...
                        $html .= '<button name="wpneo-upload" id="cc-image-upload-file-button" class="wpneo-image-upload float-right" style="display: none;">'.__( "Upload" , "wp-xwoo" ).'</button>';
                    $html .= '</div>';
		...
		if ($logged_user_info) {
			...
			$html .= '<button id="wpneo-profile-save" class="wpneo-save-btn wpneo-hidden" type="submit">' . __( "Save", "wp-xwoo" ) . '</button>';
			$html .= '</div>';
