...
class Dashboard{
    ...
    public function dashboard_block_callback( $att ){
        ...
        if( isset($_GET['page_type']) ){ $get_id = $_GET['page_type']; }
            ...
            $html .= '<style>';
                $html .= '.XWOO-dashboard .wp-crowd-btn-primary, .XWOO-dashboard .wpneo-dashboard-summary ul li.active,
                .XWOO-dashboard .wpneo-edit-btn, .XWOO-dashboard .wpneo-pagination ul li span.current, .wpneo-pagination ul li a:hover, .wpneo-pagination ul li span.current {
                    background-color: '. $majorColor .';
                }';
                $html .= '.wpneo-links div.active a, .wpneo-links div a:hover, .XWOO-dashboard .wpneo-name > p, .XWOO-dashboard .wpcrowd-listing-content .wpcrowd-admin-title h3 a{
                    color: '. $majorColor .';
                }';

                $html .= '.wpneo-links div a.wp-crowd-btn.wp-crowd-btn-primary, .wpneo-links div a.wp-crowd-btn.wp-crowd-btn-primary:hover, .XWOO-dashboard .wp-crowd-btn-primary, .XWOO-dashboard .wpneo-pagination ul li span.current, .wpneo-pagination ul li a:hover, .wpneo-pagination ul li span.current, .XWOO-dashboard .wpneo-edit-btn, .wpneo-dashboard-summary ul li.active .wpneo-value, .wpneo-dashboard-summary ul li.active .wpneo-value-info {
                    color: '. $textcolor .'
                }';
