...
add_action( 'wpneo_before_xwoo_single_campaign_summary',    array( $template_hook_obj, 'campaign_single_feature_image' ) );
add_action( 'wpneo_xwoo_after_feature_img',                 array( $template_hook_obj, 'campaign_single_description' ) );
add_action( 'wpneo_xwoo_single_campaign_summary',           array( $template_hook_obj, 'single_campaign_summary' ) );
add_action( 'wpneo_xwoo_default_single_campaign_tabs',      array( $template_hook_obj, 'single_campaign_tabs' ), 10 );
add_action( 'wpneo_after_xwoo_single_campaign_summary',     array( $template_hook_obj, 'campaign_single_tab' ) );
