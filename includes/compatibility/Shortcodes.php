...
add_shortcode( 'wpneo_xwoo_dashboard',          array( $XWOO_dashboard, 'dashboard_callback' ) );
add_shortcode( 'wpneo_xwoo_listing',            array( $XWOO_project_listing, 'listing_callback' ) );
add_shortcode( 'wpneo_xwoo_form',               array( $XWOO_campaign_submit_from, 'campaign_form_callback' ) );
