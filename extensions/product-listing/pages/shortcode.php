        ...
        <div class="xewc-tabs-content xewc-main-setting-content">
            <table class="form-table xewc-option-table xewc-main-setting-table">
                <tr class="xewc-field xewc-field-group">
                    <th>
                        <?php esc_html_e('Products Listing Shortcodes', 'x-extensions-for-woocommerce'); ?>
                    </th>

                    <td>
                        <h3><?php esc_html_e('Integration code by theme location', 'x-extensions-for-woocommerce'); ?></h3>
                        <?php
